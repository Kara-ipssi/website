        ...
        <div class="row align-items-center">
            <div class="col-lg-4 col-md-6">
                <div class="card shadow">
                    <img src="/demo/images/personal/1.jpg" alt="" class="img-fluid rounded-top">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="meta-box">
                                <div class="media">
                                    <img src="/demo/images/users/user-7.jpg" alt="" class="thumb-sm rounded-circle me-2 align-self-center">                                       
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card shadow">
                    <img src="/demo/images/personal/3.jpg" alt="" class="img-fluid rounded-top">
                    <div class="card-body">                                
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="meta-box">
                                <div class="media">
                                    <img src="/demo/images/users/user-2.jpg" alt="" class="thumb-sm rounded-circle me-2 align-self-center">                                       
                                    <div class="media-body align-self-center text-truncate">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card shadow">
                    <img src="/demo/images/personal/2.jpg" alt="" class="img-fluid rounded-top">
                    <div class="card-body">                                
                        <a href="blog-detail.html" class="fs-20 my-0 d-block fw-medium">With a clean, minimal and professional look</a>
                        <hr class="hr-dashed">
                        <div class="d-flex justify-content-between">
