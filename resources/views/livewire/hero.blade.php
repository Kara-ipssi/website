    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-7 text-center px-0 px-xl-4 mt-5 mt-lg-0 pt-5 pt-lg-0">
                <h5 class="d-inline-block py-1 px-3 rounded text-muted font-secondary">Hello, je m'appelle Karamoko</h5>
                <h1 class="hero-title mb-4 font-secondary fo">Développeur <mark><span class="fw-medium typewrite" data-period="2000" data-type='["React", "Php", "Python", "NodeJS"]'></span></mark></h1>   
                <span class="wrap"></span>                     
                <div class="mb-5 mb-lg-0">                           
                    <div class="d-inline-block">
                        <a href="#" class="btn btn-primary">Télécharger le CV</a>
                    </div>
                </div>
            </div><!--end col-->                  
        </div><!--end row-->             
